...
sim_t_end = 80.0  # simulation duration [s]
...
dist.set_current_direction(-np.pi - np.pi / 4)  # [rad]
dist.set_current_speed(0.3)  # [m/s]
...
Q = scipy.linalg.block_diag(10e3 * np.eye(2), 10e2, 10e1 * np.eye(2), 0.01)  # pos, vel
...
if SHOW_PLOTS is True:
    ...
    plt.pause(0.001)  # Prevents the plots from disappearing
