...
from seacat_dp.model.seadragon_pars import SeaDragonParameters
...
class SeaDragonModel(USVModel):
    ...
    def force_azimuth_thrusters(self, u: np.ndarray) -> np.ndarray:
        ...
        """
        # TODO: review and check that the 0 direction of the angles is well defined
