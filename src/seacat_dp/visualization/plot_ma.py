...
def plot_variables(
    ...
    # Plot x, y
    ax[1, 1].plot(t_vec, q_mat[0, :])
    ax[1, 1].plot(t_vec, q_mat[1, :])
    if q_ref_mat is not None:
        ax[1, 1].plot(t_vec, q_ref_mat[0, :], "--", color="k")
        ax[1, 1].plot(t_vec, q_ref_mat[1, :], "--", color="k")
    ...
    # Plot theta
    ax[2, 1].plot(t_vec, q_mat[2, :])
    if q_ref_mat is not None:
        ax[2, 1].plot(t_vec, q_ref_mat[2, :], "--", color="k")
    ...
    # Plot u, v
    ax[3, 1].plot(t_vec, q_mat[3, :])
    ax[3, 1].plot(t_vec, q_mat[4, :])
